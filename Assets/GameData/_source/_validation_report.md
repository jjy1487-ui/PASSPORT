...
- [확률주의] defect_rule rule_id=22 random_valid_chance 비수치='고정' (런타임 특수처리 필요)
- [확률주의] defect_rule rule_id=23 random_valid_chance 비수치='고정' (런타임 특수처리 필요)
- [확률주의] defect_rule rule_id=27 random_valid_chance 비수치='-' (런타임 특수처리 필요)
...
## 변환기 경고
- 기대 시트 누락: dialogue_case
- 기대 시트 누락: dialogue_line
